...
function TopUniversities() {
    ...
    const [secoundDivWidth, setsecoundDivWidth] = useState()
    ...
    useEffect(()=>{
        if (
            ...
            setUniDivClass("grid grid-cols-1  md:grid-cols-3  mb-[20px] mt-[20px] items-center justify-center")
            setsecoundDivWidth('w-[55%] block sticky top-[2%] h-[100%] ')
        }
        else{
            setUniDivClass('grid grid-cols-2 md:grid-cols-6 mb-[20px] mt-[20px] items-center w-[100%] mx-auto')
            setsecoundDivWidth('w-[0%] hidden')
        }
    },[divideIndicator])
  ...
  return (
    <div className='bg-[#EFF6FF] rounded-xl p-[20px] flex flex-col items-center justify-center    '>
        ...
        <div 
        className="flex items-start h-[600px] w-[100%]  overflow-scroll scrollbar-hide mx-auto justify-center   "
        onMouseLeave={() => {
            setTimeout(()=>{
                ...
                setsecoundDivWidth('hidden')
                setUniDivClass("grid grid-cols-2  md:grid-cols-6  mb-[20px] mt-[20px] items-center ml-[3%] mr-[3%]")
            }, 200)
        }}
        >
          <div >
                <div
                 className={uniDivClass} >
                <div 
                onMouseEnter={() => {
                    if (uni1View === false) {
                        setTimeout(()=>{
          ...
          <div className={secoundDivWidth}>
          <div className={`${uni1View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] transiton duration-100 ":"hidden opacity-0"}`}>
          ...
          <div className={`${uni2View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni3View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni4View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni5View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni6View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni7View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni8View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni9View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
          ...
          <div className={`${uni10View? "pl-[20px] pt-[20px] pb-[20px]  w-[100%] mt-[40px] flex flex-col items-start border-l-[2px] h-[100%] ":"hidden"}`}>
