    ...
    <div className='p-[20px]'>
        ...
        <div className="mt-[50px] h-fit ">
            <div className="flex flex-col md:flex-row  gap-4">
                <div className="bg-[#59C3CF] md:w-[48%] shadow-lg rounded-[32px] p-[20px] h-[500px]  md:h-[400px] cursor-pointer hover:h-[900px] md:hover:h-[600px] hover:ease-out overflow-hidden duration-500 delay-150  relative group">
                ...
                <div className="flex items-center justify-between group-hover:flex-col group-hover:items-center ">
                    ...
                    <img className="w-[280px] group-hover:absolute group-hover:bottom-0 duration-500 delay-150" src={diplomaImg} alt="Diploma" />
                </div>
                </div>
                <div className="bg-[#E2635E] md:w-[48%] shadow-lg rounded-[32px] p-[20px] h-[400px]  md:h-[400px] cursor-pointer hover:h-[900px] md:hover:h-[600px] hover:ease-out overflow-hidden relative duration-500 delay-150  group">
            ...
            <div className="flex flex-col md:flex-row  gap-4 mt-[20px] ">
                <div className="bg-[#A881F3] md:w-[48%] shadow-lg rounded-[32px] p-[20px] h-[400px] cursor-pointer hover:h-[800px] md:hover:h-[600px] hover:ease-out overflow-hidden relative duration-500 delay-150  group">
                ...
                <div className="bg-[#58B1EA] md:w-[48%] shadow-lg rounded-[32px] p-[20px] h-[400px] cursor-pointer hover:h-[800px] md:hover:h-[600px] hover:ease-out overflow-hidden relative duration-500 delay-150  group">
