    ...
    <div className='mt-[50px] overflow-hidden'>
        <div className='flex z-[0]'>
            <h1 onClick={()=>{setBtn1State(true), setBtn2State(false), setBtn3State(false), setBtn4State(false)}}  className={`${btn1State ===true ?
                'text-[20px] font-[700] cursor-pointer p-[15px] rounded-t-[30px] bg-[#EFF6FF]  w-[25%] text-center ':
                "cursor-pointer p-[20px] rounded-t-[20px] bg-[#59C3CF] text-[20px] text-white font-[700]  w-[25%] text-center " }`}>Programs & Duration</h1>
            <h1 onClick={()=>{setBtn1State(false), setBtn2State(true), setBtn3State(false), setBtn4State(false)}}  className={`${btn2State ===true ?
                'text-[20px] font-[700] cursor-pointer p-[15px] rounded-t-[30px] bg-[#EFF6FF]  w-[25%] text-center ':
                "cursor-pointer p-[20px] rounded-t-[20px] bg-[#9667EF] text-[20px] text-white font-[700]  w-[25%] text-center  " }`}>Cost of Studying</h1>
            <h1 onClick={()=>{setBtn1State(false), setBtn2State(false), setBtn3State(true), setBtn4State(false)}}  className={`${btn3State ===true ?
                'text-[20px] font-[700] cursor-pointer p-[15px] rounded-t-[30px] bg-[#EFF6FF]  w-[25%] text-center  ':
                "cursor-pointer p-[20px] rounded-t-[20px] bg-[#E2635E] text-[20px] text-white font-[700]  w-[25%] text-center  " }`}>Academic Intakes</h1>
            <h1 onClick={()=>{setBtn1State(false), setBtn2State(false), setBtn3State(false), setBtn4State(true)}}  className={`${btn4State ===true ?
                'text-[20px] font-[700] cursor-pointer p-[15px] rounded-t-[30px] bg-[#EFF6FF] w-[25%] text-center ':
                "cursor-pointer p-[20px] rounded-t-[20px] bg-[#58B1EA] text-[20px] text-white font-[700] w-[25%] text-center " }`}>Deadline</h1>
        </div>
